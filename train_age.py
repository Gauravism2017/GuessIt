...
from src.Generator_age import DataGenerator
...
checkpoint = keras.callbacks.callbacks.ModelCheckpoint('./save/age/model.h5', monitor=rmse, mode = 'min', verbose=0, save_best_only=True)
tensorboard = keras.callbacks.tensorboard_v1.TensorBoard(log_dir='./logs/age/', histogram_freq=0, batch_size=64, write_graph=True, 
